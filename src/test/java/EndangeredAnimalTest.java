...
public class EndangeredAnimalTest {
    ...
    public void endangeredAnimal_instantiatesCorrectly_true() {
        EndangeredAnimal testEndangeredAnimal = new EndangeredAnimal("Hyena", "Healthy", "Young");
    ...
    public void all_returnsAllInstancesOfEndangeredAnimal_true() {
        ...
        EndangeredAnimal secondEndangeredAnimal = new EndangeredAnimal("Deer", "Okay", "Adult");
    ...
    public void find_returnsAnimalWithSameId_secondAnimal() {
        EndangeredAnimal firstEndangeredAnimal = new EndangeredAnimal("Hyena", "Healthy", "Young");
        firstEndangeredAnimal.save();
        EndangeredAnimal secondEndangeredAnimal = new EndangeredAnimal("Hyena", "Healthy", "Young");
        secondEndangeredAnimal.save();
    ...
    public void update_updatesHealthAttribute_true() {
        ...
        assertEquals("Healthy", EndangeredAnimal.find(testEndangeredAnimal.getId()).getHealth());
    }
